...
# 📝 Prompt for generating Multiple-Choice Questions (MCQs)
mcq_prompt_template = PromptTemplate(
    ...
    input_variables=["topic", "difficulty"],  # Dynamic values to fill into the prompt
)

# 📝 Prompt for generating Fill-in-the-Blank Questions
